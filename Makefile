...
KERNEL		= kernel/schedule.c kernel/RR.c kernel/task.c kernel/signal.c kernel/fork.c kernel/fork_internal.s kernel/exec.c \
			  kernel/wait.c kernel/kill.c
...
TOOLS		= tools/shell/shell.c tools/shell/builtin.c tools/hexapawn.c tools/time.c tools/colorful.c
